...
$wshell = New-Object -ComObject wscript.shell;Start-Process "https://www.youtube.com/watch?v=zn3Wdo23Z4o";Sleep 3;$wshell.SendKeys('"{Enter}"');Sleep 5;$wshell.SendKeys('"{F}"')
